  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        {/* Hero Section */}
      <section
        className="relative h-[60vh] min-h-[500px] flex items-center justify-center text-center px-4"
        style={{
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-ocean-light dark:bg-ocean rounded-full flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-10 h-10 text-ocean-dark dark:text-white" />
              </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-ocean-light dark:bg-ocean rounded-full flex items-center justify-center mx-auto mb-4">
                <Bot className="w-10 h-10 text-ocean-dark dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-ocean-light dark:bg-ocean rounded-full flex items-center justify-center mx-auto mb-4">
                <Waves className="w-10 h-10 text-ocean-dark dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-ocean-light dark:bg-ocean rounded-full flex items-center justify-center mx-auto mb-4">
                <Activity className="w-10 h-10 text-ocean-dark dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
      ...
      {/* About Section */}
      <section className="py-16 px-4 bg-gradient-to-br from-ocean/10 to-ocean-light/10 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-ocean mb-2">250+</h3>
              <p className="text-gray-600 dark:text-gray-300">Spots au Québec</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
              <div className="text-4xl mb-3">⛅</div>
              <h3 className="text-2xl font-bold text-ocean mb-2">Temps Réel</h3>
              <p className="text-gray-600 dark:text-gray-300">Météo et conditions</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
              <div className="text-4xl mb-3">👥</div>
              <h3 className="text-2xl font-bold text-ocean mb-2">Communauté</h3>
              <p className="text-gray-600 dark:text-gray-300">Mondiale de passionnés</p>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="bg-ocean-dark text-white py-8 text-center">
